...
import { ScrollView, Text, TextInput, View, Button, FlatList, StyleSheet, Image, Modal, Alert } from 'react-native';
	...
	render() {
		return (
			<View style={styles.mainContainer}>
				<Header headerText={'Members'} openDrawer={() => this.props.navigation.toggleDrawer()} />
			<ScrollView>
        <Text>ABCDEF</Text>
