...
import { Button, Text, View, Modal, Alert, FlatList, StyleSheet, TouchableOpacity, TextInput } from 'react-native';
...
class ContributionComponents extends Component {
	...
	addTag(tagName) {
		...
		if (this.state.tags[tagName]) {
			newValue[tagName] = {name: tagName, isActive: !this.state.tags[tagName].isActive};
		}
            ...
            Alert.alert('Modal has been closed.');
              ...
              <View>
              	...
              	<View>
		            ...
		            style={(this.state.tags[item.key]?.isActive) ? Styles.tagOrange : Styles.tagBlue}>
